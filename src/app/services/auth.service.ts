...
export class AuthService {
  ...
  startSessionCheck() {
    ...
    interval(60000).pipe(
      ...
      if (!this.isActive && !this.isLicenceKeyDialogOpen) {
        ...
        this.fun.presentAlertError('Your session will expire in 5 seconds!');
  ...
  /**
   * Método para obtener el token de acceso del almacenamiento de sesión.
  ...
  /**
   * Método para obtener el token de actualización del almacenamiento de sesión.
